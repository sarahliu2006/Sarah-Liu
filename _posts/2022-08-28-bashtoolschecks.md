---
keywords: fastai
description: Bash Tool Checks
title: Sarah's Bash Tool Checks
toc: true 
badges: true
comments: true
tags: true
categories: [jupyter,Week01,tri1]
nb_path: _notebooks/2022-08-28-bashtoolschecks.ipynb
layout: notebook
---
...
#################################################
# file to edit: _notebooks/2022-08-28-bashtoolschecks.ipynb
-->
...
<span class="nb">export</span> <span class="nv">project_dir</span><span class="o">=</span><span class="nv">$HOME</span>/vscode  
<span class="nb">export</span> <span class="nv">project</span><span class="o">=</span><span class="nv">$project_dir</span>/APCSP  
<span class="nb">export</span> <span class="nv">project_repo</span><span class="o">=</span><span class="s2">&quot;https://sarahliu2006.github.io/Sarah-Liu/&quot;</span>  
...
Directory /home/sarahl/vscode exists.
Directory /home/sarahl/vscode/APCSP exists.
</pre>
</div>
</div>
...
<span class="nb">export</span> <span class="nv">project_dir</span><span class="o">=</span><span class="nv">$HOME</span>/hacks 
<span class="nb">export</span> <span class="nv">project</span><span class="o">=</span><span class="nv">$project_dir</span>/APCSP  
<span class="nb">export</span> <span class="nv">project_repo</span><span class="o">=</span><span class="s2">&quot;https://github.com/nighthawkcoders/APCSP.git&quot;</span>  
...
<div class="output_subarea output_stream output_stdout output_text">
<pre>Using conditional statement to create a project directory and project
Directory /home/sarahl/hacks does not exists... makinng directory /home/sarahl/hacks
Directory /home/sarahl/hacks exists.
Directory /home/sarahl/hacks/APCSP does not exists... cloning https://github.com/nighthawkcoders/APCSP.git
Cloning into &#39;APCSP&#39;...
...
Receiving objects: 100% (9627/9627), 16.53 MiB | 18.92 MiB/s, done.
Resolving deltas: 100% (5247/5247), done.
Directory /home/sarahl/hacks/APCSP exists.
</pre>
</div>
</div>
...
/home/sarahl/vscode/APCSP

list top level or root of files with project pulled from github
 <span class="ansi-green-intense-fg ansi-bold">Gemfile</span>         _config.yml       <span class="ansi-blue-intense-fg ansi-bold">_pages</span>     <span class="ansi-blue-intense-fg ansi-bold">assets</span>                  <span class="ansi-blue-intense-fg ansi-bold">python</span>
 LICENSE         <span class="ansi-blue-intense-fg ansi-bold">_fastpages_docs</span>   <span class="ansi-blue-intense-fg ansi-bold">_plugins</span>   <span class="ansi-green-intense-fg ansi-bold">docker-compose.yml</span>
 <span class="ansi-green-intense-fg ansi-bold">Makefile</span>        <span class="ansi-blue-intense-fg ansi-bold">_includes</span>         <span class="ansi-blue-intense-fg ansi-bold">_posts</span>    &#39;first markdown.ipynb&#39;
 <span class="ansi-green-intense-fg ansi-bold">README.md</span>       <span class="ansi-blue-intense-fg ansi-bold">_layouts</span>          <span class="ansi-blue-intense-fg ansi-bold">_sass</span>      <span class="ansi-blue-intense-fg ansi-bold">images</span>
 <span class="ansi-blue-intense-fg ansi-bold">_action_files</span>   <span class="ansi-blue-intense-fg ansi-bold">_notebooks</span>        <span class="ansi-blue-intense-fg ansi-bold">_word</span>      index.html

list again with hidden files pulled from github
 <span class="ansi-blue-intense-fg ansi-bold">.</span>                    <span class="ansi-green-intense-fg ansi-bold">Gemfile</span>           <span class="ansi-blue-intense-fg ansi-bold">_layouts</span>     <span class="ansi-green-intense-fg ansi-bold">docker-compose.yml</span>
 <span class="ansi-blue-intense-fg ansi-bold">..</span>                   LICENSE           <span class="ansi-blue-intense-fg ansi-bold">_notebooks</span>  &#39;first markdown.ipynb&#39;
 .devcontainer.json   <span class="ansi-green-intense-fg ansi-bold">Makefile</span>          <span class="ansi-blue-intense-fg ansi-bold">_pages</span>       <span class="ansi-blue-intense-fg ansi-bold">images</span>
 <span class="ansi-blue-intense-fg ansi-bold">.git</span>                 <span class="ansi-green-intense-fg ansi-bold">README.md</span>         <span class="ansi-blue-intense-fg ansi-bold">_plugins</span>     index.html
 .gitattributes       <span class="ansi-blue-intense-fg ansi-bold">_action_files</span>     <span class="ansi-blue-intense-fg ansi-bold">_posts</span>       <span class="ansi-blue-intense-fg ansi-bold">python</span>
 <span class="ansi-blue-intense-fg ansi-bold">.github</span>              _config.yml       <span class="ansi-blue-intense-fg ansi-bold">_sass</span>
 .gitignore           <span class="ansi-blue-intense-fg ansi-bold">_fastpages_docs</span>   <span class="ansi-blue-intense-fg ansi-bold">_word</span>
 <span class="ansi-blue-intense-fg ansi-bold">.vscode</span>              <span class="ansi-blue-intense-fg ansi-bold">_includes</span>         <span class="ansi-blue-intense-fg ansi-bold">assets</span>

list all files in long format
total 124
drwxr-xr-x 18 sarahl sarahl  4096 Aug 22 08:17  <span class="ansi-blue-intense-fg ansi-bold">.</span>
drwxr-xr-x  7 sarahl sarahl  4096 Aug 22 14:38  <span class="ansi-blue-intense-fg ansi-bold">..</span>
-rw-r--r--  1 sarahl sarahl   420 Aug 21 16:30  .devcontainer.json
drwxr-xr-x  8 sarahl sarahl  4096 Aug 22 12:01  <span class="ansi-blue-intense-fg ansi-bold">.git</span>
-rw-r--r--  1 sarahl sarahl    84 Aug 21 16:30  .gitattributes
drwxr-xr-x  4 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">.github</span>
-rw-r--r--  1 sarahl sarahl   917 Aug 21 16:30  .gitignore
drwxr-xr-x  2 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">.vscode</span>
-rwxr-xr-x  1 sarahl sarahl  1304 Aug 21 16:30  <span class="ansi-green-intense-fg ansi-bold">Gemfile</span>
-rw-r--r--  1 sarahl sarahl 11351 Aug 21 16:30  LICENSE
-rwxr-xr-x  1 sarahl sarahl  1422 Aug 21 16:30  <span class="ansi-green-intense-fg ansi-bold">Makefile</span>
-rwxr-xr-x  1 sarahl sarahl  3614 Aug 21 16:30  <span class="ansi-green-intense-fg ansi-bold">README.md</span>
drwxr-xr-x  2 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">_action_files</span>
-rw-r--r--  1 sarahl sarahl  3724 Aug 22 00:05  _config.yml
drwxr-xr-x  2 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">_fastpages_docs</span>
drwxr-xr-x  2 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">_includes</span>
drwxr-xr-x  2 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">_layouts</span>
drwxr-xr-x  3 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">_notebooks</span>
drwxr-xr-x  2 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">_pages</span>
drwxr-xr-x  2 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">_plugins</span>
drwxr-xr-x  2 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">_posts</span>
drwxr-xr-x  3 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">_sass</span>
drwxr-xr-x  2 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">_word</span>
drwxr-xr-x  4 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">assets</span>
-rwxr-xr-x  1 sarahl sarahl  1136 Aug 21 16:30  <span class="ansi-green-intense-fg ansi-bold">docker-compose.yml</span>
-rw-r--r--  1 sarahl sarahl  1105 Aug 22 11:13 &#39;first markdown.ipynb&#39;
drwxr-xr-x  5 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">images</span>
-rw-r--r--  1 sarahl sarahl  1061 Aug 21 16:30  index.html
drwxr-xr-x  2 sarahl sarahl  4096 Aug 21 16:30  <span class="ansi-blue-intense-fg ansi-bold">python</span>
</pre>
</div>
</div>
...
<div class="output_subarea output_stream output_stdout output_text">
<pre># packages in environment at /home/sarahl/anaconda3:
#
...
traitlets        : 5.3.0
Available kernels:
  bash          /home/sarahl/.local/share/jupyter/kernels/bash
  javascript    /home/sarahl/.local/share/jupyter/kernels/javascript
  python3       /home/sarahl/.local/share/jupyter/kernels/python3
</pre>
</div>
</div>
